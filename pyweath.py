...
def main():
    a=weather_for_zip("RSXX0091")
    print '├ Температура:',a['current_temp'],'°C'
    print '├ Состояние  :',a['current_condition']
    print '├ Ощущается  :',a['feel_like'], '°C'
    print '├ Ветер      :',a['wind'], 'km/h'
    print '├ Влажность  :',a['humidity'], '%'
    print '├ Восход     :',a['sunrise']
    print '├ Закат      :',a['sunset']
